...
Given o "monitor" "ainda não definiu horário para a monitoria"  
...
Given o "monitor" "já possui compromissos cadastrados em determinados horários"  
...
Given o "monitor" "já possui um horário de monitoria definido"  
